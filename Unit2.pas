...
begin
  ...
  zqry1.SQL.Clear;
  zqry1.SQL.Add('Update hubungan set id_siswa= "'+edt1.Text+'", id_ortu="'+edt2.Text+'", status_hub="'+cmb1.Text+'", keterangan="'+cmb2.Text+'", status_ortu="'+cmb3.Text+'"  where hubungan.id="'+id+'"');
  zqry1.ExecSQL;
...
begin
  ...
  begin
   zqry1.SQL.Clear;
   zqry1.SQL.Add('delete from hubungan where id= "'+edt1.Text+'"');
   zqry1.ExecSQL;
